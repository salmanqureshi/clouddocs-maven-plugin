 ...
 */
public class RackspaceMetadataExtractor extends DefaultStep
{
     ...
     */
    public RackspaceMetadataExtractor(XProcRuntime runtime, XAtomicStep step) {
        super(runtime,step);
    }
            ...
            if ((width == -1 || depth == -1) && imageFailed) {
                ...
                try {
                    ...
                    if (line != null && line.startsWith("%PDF-")) {
                        ...
                        System.err.println("@Override: Failed to interpret image: " + imageFn);
                    }
                } catch (Exception e) {
                    System.err.println("@Override: Failed to load image: " + imageFn);
                    // nop;
                }
